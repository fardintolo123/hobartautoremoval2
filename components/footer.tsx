...
export function Footer() {
  return (
    <footer style={{ backgroundColor: "#0f172a" }} role="contentinfo">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-3 gap-12">
          {/* Col 1 — Contact */}
          <div>
            <div className="flex items-center gap-2 mb-5">
              <div className="w-7 h-7 rounded-lg flex items-center justify-center" style={{ backgroundColor: "rgba(249,115,22,0.15)" }}>
                <PaintBucket className="w-3.5 h-3.5" style={{ color: "#f97316" }} />
              </div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3 text-sm" style={{ color: "#475569" }}>
          ...
          {/* Col 2 — Quick links */}
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-widest mb-5" style={{ color: "#94a3b8" }}>
              Quick Links
            </h3>
            <ul className="space-y-3">
              {[
            ...
            {/* Social */}
            <div className="mt-8">
              <h3 className="text-sm font-semibold uppercase tracking-widest mb-4" style={{ color: "#94a3b8" }}>
                Follow Along
              </h3>
              <div className="flex gap-3">
                {[
                  ...
                  <a
                    ...
                    aria-label={label}
                    className="w-9 h-9 rounded-lg flex items-center justify-center border border-white/10 transition-all"
                    style={{ color: "#64748b" }}
                    onMouseEnter={(e) => {
          ...
          <div>
            ...
            <div
              className="rounded-xl p-5 border border-white/10 mb-6"
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-semibold uppercase tracking-widest mb-3" style={{ color: "#94a3b8" }}>
                Legal
              </h3>
